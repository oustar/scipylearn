...
class Perceptron(object):
    ...
    def predict(self, input_vec):
        ...
        c = map(lambda x, w: x * w, input_vec, self.weights)
        d = reduce(lambda a, b : a + b,  c , 0.0)
        
        return self.activator(d + self.bias)
    ...
    def _update_weight(self, input_vec, output, label, rate):
        ...
        delat = label - output
        self.weights = list(map(lambda w, x: w + rate * delat * x,
